...
<div class="container">
    ...
    <form method="post" action="index.php">
        ...
        <div class="form-group">
            ...
            <div class="radio-group">
                ...
                <label><input type="radio" name="gender" value="female" <?= $form_data['gender'] === 'female' ? 'checked' : '' ?> required> Женский</label>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea id="biography" name="biography" rows="7"><?= htmlspecialchars($form_data['biography']) ?></textarea>
        </div>
    ...
    <div class="footer-links">
        <a href="o.html">Этапы выполнения</a>
